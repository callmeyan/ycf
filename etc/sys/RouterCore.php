...
class RouterCore
{
    ...
    public function init($config = null)
    {
        ...
        if ($config) {
            ...
            if (isset($config['template']) && $config['template']) {
                ...
                $this->twig = $this->tmpt->initEnv($config['template']['engine'],$config['template']['tpl_config'],$this->mode);
            }
    ...
    private function initPathInfo()
    {
        ...
        $this->contextPath = dirname($fileName).'';
    ...
    public function dispatch()
    {
        ...
        if ($router) {
            ...
            $this->error(404,new RouterException("Not Page Found"));
        }
    }
